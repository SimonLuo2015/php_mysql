...
?>
  ...
  <tr>
  <td bgcolor = "#5B69A6" width = 73><img src = "images/pyramid.gif"
                 width = 73 height = 49 alt ="" valign = "middle" /></td>
  <td bgcolor = "#5B69A6" width = <?php echo $table_width-73;?>><h1><?php echo $title?></h1></td>
  </tr>
  </table>
...
?>
  ...
  <table width = <?php echo $table_width?> cellspacing = 0 cellpadding = 6 border = 0>
  <tr>
  <td bgcolor = "#5B69A6" align = "right"><img src = "images/pyramid.gif"
                 width = 73 height = 49 alt ="" valign = "middle" />
  </td>
  </tr>
  </table>
  </body>
        ...
        for ($i = 0; $i < $items; $i++) {
            ...
            for ($j = 1; $j <= 3; $j++) {
                ...
                if ($$var) {
                    ...
                    // view/preview buttons are a special case as
                    // they link to a file
                    if (($$var == 'preview-html') || ($$var == 'view-html') ||
                        ($$var == 'preview-text') || ($$var == 'view-text')) {
                        display_preview_button($list[$i][3],
                                               $list[$i][0],
                                               $$var);
                    } else {
...
?>
  ...
  <table bgcolor='#cccccc' cellpadding = 6 cellspacing = 0 border =0>
   ...
   <tr>
     <td>Real Name:</td>
     <td><input type = "text" name = "realname" maxlength = 100
   ...
   <tr>
     ...
     <?php
       echo '<td><select name = "mimetype"><option';
       if ($mimetype == 'T')
          echo ' selected';
