...
function insert_order($order_details) {
    ...
    $query = "insert into orders values
              (NULL, '$customerid', '".$_SESSION['total_price']."',
    ...
    $query = "select orderid from orders
              ...
              amount > ".($_SESSION['total_price'] - 0.01)." and
              amount < ".($_SESSION['total_price'] + 0.01)." and
              date='$date' and
